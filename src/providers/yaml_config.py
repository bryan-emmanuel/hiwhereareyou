...
class YAMLConfigProvider(ConfigProvider):
    ...
    def get_game_config(self) -> GameConfig:
        ...
        admin_channel_raw = os.environ.get("TELEGRAM_ADMIN_CHANNEL_ID", telegram_data.get("admin_channel_id", ""))
        try:
            telegram_admin_channel_id = int(admin_channel_raw)
        except ValueError:
            telegram_admin_channel_id = admin_channel_raw
        ...
        twilio_admin_phone_number = os.environ.get("TWILIO_ADMIN_PHONE_NUMBER", twilio_data.get("admin_phone_number", ""))
        ...
        return GameConfig(
            ...
            twilio_admin_phone_number=twilio_admin_phone_number,
